...
//            ResultSet rs=st.executeQuery("SELECT * FROM `employee`");
            ...
            ResultSet res = sta.executeQuery("SELECT `Emp_id`, `Emp_name`, `Emp_post`, `Emp_gender`, `Emp_telephone`, `Emp_address`, `Emp_nic`, `Emp_contact_person`, `Emp_contact_person_tel`, `Emp_date`, `Emp_username`, ` ` FROM `employee` ");
